...
export const AnimatedSpan = ({
  ...
  // Full transform string (hardware-accelerated, unlike the `y` shorthand);
  // reduced motion keeps the fade and drops the offset.
  ...
  return (
    <motion.div
      ref={elementRef}
      initial={hidden}
      animate={shouldAnimate ? { opacity: 1, transform: "none" } : hidden}
      transition={{
        duration: 0.3,
        ease: [0.23, 1, 0.32, 1],
